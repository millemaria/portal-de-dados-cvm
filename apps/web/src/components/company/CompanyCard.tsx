  ...
  return (
    ...
    >
      <Link href={`/companies/${company.ticker}`} className="block h-full group">
        <div className="glass-card p-4 sm:p-5 h-full flex flex-col justify-between border border-slate-800/90 bg-slate-900/80 hover:bg-slate-900 hover:border-cyan-500/60 hover:shadow-xl hover:shadow-cyan-500/10 transition-all duration-300 rounded-2xl">
          <div>
            {/* Top Row: Icon + Ticker + Arrow */}
            <div className="flex items-start justify-between gap-3 mb-3">
              <div className="flex items-center gap-3 min-w-0 flex-1">
                <div className="flex h-10 w-10 sm:h-11 sm:w-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500/20 via-blue-500/20 to-purple-500/20 border border-cyan-500/30 group-hover:scale-105 group-hover:border-cyan-400/50 transition-all duration-200">
              ...
              <div className="p-1.5 sm:p-2 rounded-xl bg-slate-800/60 text-slate-400 group-hover:text-cyan-400 group-hover:bg-cyan-500/15 group-hover:translate-x-1 transition-all">
          ...
          <div className="grid grid-cols-2 gap-2 pt-3 border-t border-slate-800/80 mt-2">
            <div className="bg-slate-950/70 rounded-xl p-2.5 border border-slate-800/90 min-w-0">
